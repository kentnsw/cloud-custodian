        ...
        p = self.load_policy(
            {
                ...
                'actions': [
                    {'type': 'update', 'WindowsConfiguration': {'AutomaticBackupRetentionDays': 3}}
                ],
            },
            session_factory=session_factory,
        )
        ...
        p = self.load_policy(
            {
                ...
                'actions': [
                    {'type': 'backup', 'copy-tags': True, 'tags': {'test-tag': 'backup-tag'}}
                ],
            },
            session_factory=session_factory,
        )
        ...
        p = self.load_policy(
            {
                ...
                'filters': [{'FileSystemId': 'fs-002ccbccdcf032728'}],
                'actions': [
                    {'type': 'backup', 'copy-tags': False, 'tags': {'test-tag': 'backup-tag'}}
                ],
            },
            session_factory=session_factory,
        )
