...
class LogGroupTest(BaseTest):
    ...
    def test_put_subscription_filter(self):
        ...
        resources = p.run()
        self.assertEqual(len(resources), 1)
        subscription_filter = client.describe_subscription_filters(
    ...
    def test_last_write(self):
        ...
        self.assertNotEqual(
            resources[0]["lastWrite"].timestamp() * 1000, float(resources[0]["creationTime"])
        )
        ...
        p = self.load_policy(
            {
                ...
                'filters': [
                    ...
                    {"type": "metrics", "name": "IncomingBytes", "value": 1, "op": "greater-than"},
                ],
            },
            config={'region': 'us-west-2'},
            session_factory=session_factory,
        ...
        p = self.load_policy(
            {
                ...
                "filters": [
                    {"type": "value", "key": "logGroupName", "value": "metric-filter-test1"}
                ],
            },
