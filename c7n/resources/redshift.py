...
from c7n.filters import ValueFilter, DefaultVpcBase, AgeFilter, CrossAccountAccessFilter, Filter
...
class ClusterConsecutiveSnapshots(Filter):
    ...
    def process_resource_set(self, client, resources, lbdate):
        ...
        rs_snapshots = paginator.paginate(StartTime=lbdate).build_full_result().get('Snapshots', [])
