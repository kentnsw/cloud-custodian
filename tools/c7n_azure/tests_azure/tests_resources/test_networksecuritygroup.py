            ...
            p = self.load_policy(
                {
                    ...
                    'filters': [
                        {'type': 'ingress', 'ports': '80', 'access': 'Allow'},
                        {'type': 'egress', 'ports': '22', 'ipProtocol': 'TCP', 'access': 'Allow'},
                    ],
                    'actions': [
                        {'type': 'open', 'ports': '1000-1100', 'direction': 'Inbound'},
                        {'type': 'close', 'ports': '1000-1100', 'direction': 'Inbound'},
                    ],
                },
                validate=True,
            )
        ...
        p = self.load_policy(
            {
                ...
                'filters': [
                    ...
                    {'type': 'ingress', 'ports': '80', 'source': '*', 'access': 'Allow'},
                ],
            }
        )
        ...
        p = self.load_policy(
            {
                ...
                'filters': [
                    ...
                    {'type': 'ingress', 'ports': '40-100', 'match': 'any', 'access': 'Allow'},
                ],
            }
        )
        ...
        p = self.load_policy(
            {
                ...
                'filters': [
                    ...
                    {'type': 'ingress', 'ports': '8086', 'access': 'Deny'},
                ],
            }
        )
        ...
        p = self.load_policy(
            {
                ...
                'filters': [
                    ...
                    {'type': 'egress', 'ports': '22', 'ipProtocol': 'UDP', 'access': 'Allow'},
                ],
            }
        )
        ...
        p = self.load_policy(
            {
                ...
                'filters': [
                    ...
                    {'type': 'ingress', 'ports': '1000-1100', 'match': 'any', 'access': 'Deny'},
                ],
            }
        )
        ...
        p = self.load_policy(
            {
                'name': 'test-azure-nsg',
                'resource': 'azure.networksecuritygroup',
                'filters': [{'type': 'flow-logs', 'key': 'length(logs)', 'value': 0}],
            }
        )
        ...
        p = self.load_policy(
            {
                'name': 'test-azure-nsg',
                'resource': 'azure.networksecuritygroup',
                'filters': [{'type': 'flow-logs', 'key': 'length(logs)', 'op': 'gt', 'value': 0}],
            }
        )
