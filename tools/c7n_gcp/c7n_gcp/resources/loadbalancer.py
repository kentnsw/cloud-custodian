...
class LoadBalancingAddress(QueryResourceManager):
    ...
    class resource_type(TypeInfo):
        ...
        scope = 'project'
        name = id = 'name'
        default_report_fields = [name, "description", "address", "status", "region", "addressType"]
    ...
    class resource_type(TypeInfo):
        ...
        def get(client, resource_info):
            return client.execute_command(
                ...
                {
                    'project': resource_info['project_id'],
                    'urlMap': resource_info['resourceName'].rsplit('/', 1)[-1],
                },
            )
...
class LoadBalancingTargetTcpProxy(QueryResourceManager):
    ...
    class resource_type(TypeInfo):
        ...
        scope = 'project'
        name = id = 'name'
        default_report_fields = ["name", "description", "creationTimestamp", "service"]
        ...
        def get(client, resource_info):
            return client.execute_command(
                ...
                {
                    'project': resource_info['project_id'],
                    'targetTcpProxy': resource_info['resourceName'].rsplit('/', 1)[-1],
                },
            )
...
class LoadBalancingTargetSslProxy(QueryResourceManager):
    ...
    class resource_type(TypeInfo):
        ...
        scope = 'project'
        name = id = 'name'
        default_report_fields = ["name", "description", "creationTimestamp", "service", "sslPolicy"]
        ...
        def get(client, resource_info):
            return client.execute_command(
                ...
                {
                    'project': resource_info['project_id'],
                    'targetSslProxy': resource_info['resourceName'].rsplit('/', 1)[-1],
                },
            )
...
class LoadBalancingSslPolicy(QueryResourceManager):
    ...
    class resource_type(TypeInfo):
        ...
        scope = 'project'
        name = id = 'name'
        default_report_fields = ["name", "description", "profile", "minTlsVersion"]
        ...
        def get(client, resource_info):
            return client.execute_command(
                ...
                {
                    'project': resource_info['project_id'],
                    'sslPolicy': resource_info['resourceName'].rsplit('/', 1)[-1],
                },
            )
...
class LoadBalancingTargetHttpsProxy(QueryResourceManager):
    ...
    class resource_type(TypeInfo):
        ...
        scope = 'project'
        name = id = 'name'
        default_report_fields = [name, "description", "creationTimestamp", "sslPolicy", "urlMap"]
    ...
    class resource_type(TypeInfo):
        ...
        def get(client, resource_info):
            return client.execute_command(
                ...
                {
                    'project': resource_info['project_id'],
                    'backendBucket': resource_info['resourceName'].rsplit('/', 1)[-1],
                },
            )
    ...
    class resource_type(TypeInfo):
        ...
        def get(client, resource_info):
            return client.execute_command(
                ...
                {
                    'project': resource_info['project_id'],
                    'httpHealthCheck': resource_info['resourceName'].rsplit('/', 1)[-1],
                },
            )
    ...
    class resource_type(TypeInfo):
        ...
        def get(client, resource_info):
            return client.execute_command(
                ...
                {
                    'project': resource_info['project_id'],
                    'healthCheck': resource_info['resourceName'].rsplit('/', 1)[-1],
                },
            )
...
class LoadBalancingTargetHttpProxy(QueryResourceManager):
    ...
    class resource_type(TypeInfo):
        ...
        scope = 'project'
        name = id = 'name'
        default_report_fields = ["name", "description", "creationTimestamp", "region", "urlMap"]
        ...
        def get(client, resource_info):
            return client.execute_command(
                ...
                {
                    'project': resource_info['project_id'],
                    'targetHttpProxy': resource_info['resourceName'].rsplit('/', 1)[-1],
                },
            )
    ...
    class resource_type(TypeInfo):
        ...
        def get(client, resource_info):
            return client.execute_command(
                ...
                {
                    'project': resource_info['project_id'],
                    'backendService': resource_info['resourceName'].rsplit('/', 1)[-1],
                },
            )
        ...
        def get(client, resource_info):
            return client.execute_command(
                'get',
                {
                    ...
                    'targetInstance': resource_info['resourceName'].rsplit('/', 1)[-1],
                },
            )
        ...
        def get(client, resource_info):
            return client.execute_command(
                'get',
                {
                    ...
                    'targetPool': resource_info['resourceName'].rsplit('/', 1)[-1],
                },
            )
