...
class TestSecurityComandCenterFindingsFilter(BaseTest):
    def test_findings(self):
        ...
        self.assertEqual(len(resources), 1)
        self.assertEqual(
            resources[0]['c7n:matched-findings'][0]['category'], 'BUCKET_LOGGING_DISABLED'
        )
        ...
        p = self.load_policy(
            {
                ...
                "filters": [
                    {'type': 'value', 'key': 'name', 'value': 'test-metric-1'},
                    {'type': 'alerts'},
                ],
            },
            session_factory=session_factory,
        ...
        p = self.load_policy(
            {
                ...
                "resource": "gcp.log-project-metric",
                "filters": [
                    {'type': 'value', 'key': 'name', 'value': 'test-metric-2'},
                    {'type': 'alerts'},
                ],
            },
            session_factory=session_factory,
            ...
            self.load_policy(
                {
                    ...
                    "resource": "gcp.bucket",
                    "filters": [
                        {'type': 'value', 'key': 'name', 'value': 'some-bucket'},
                        {'type': 'alerts'},
                    ],
                }
            )
