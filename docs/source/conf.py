# -*- coding: utf-8 -*-
#
# Cloud Custodian documentation build configuration file, created by
...
htmlhelp_basename = 'CloudCustodiandoc'
...
latex_documents = [
    (
        master_doc,
        'CloudCustodian.tex',
        u'Cloud Custodian Documentation',
        u'Kapil Thangavelu',
        'manual',
    ),
]
...
man_pages = [(master_doc, 'cloudCustodian', u'Cloud Custodian Documentation', [author], 1)]
